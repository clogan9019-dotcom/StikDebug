    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section {
                    NavigationLink {
                        KernelExploitSettingsView()
                    } label: {
                        Label {
                            VStack(alignment: .leading, spacing: 2) {
                                Text("Kernel Exploit JIT")
                                Text("DarkSword-based JIT without LocalDevVPN")
                                    .font(.caption).foregroundStyle(.secondary)
                            }
                        } icon: {
                    ...
                    Text("Alternative JIT Method")
                } footer: {
                    Text("Enables JIT by patching the kernel directly. Requires iOS 17.0–18.7.1 or iOS 26.0.x. Does not work on iOS 26.3+ or M5/A19 devices.")
                }
